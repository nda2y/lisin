	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				elseif($this->ion_auth->in_group('instrumen'))
				{
					redirect('instrumen', 'refresh');
				}
				elseif($this->ion_auth->in_group('ELEKTRONIKA'))
				{
					redirect('elektronika', 'refresh');
				}
				elseif($this->ion_auth->in_group('ac'))
				{
					redirect('ac', 'refresh');
				}
				elseif($this->ion_auth->in_group('jaringan'))
				{
					redirect('jaringan', 'refresh');
				}
				elseif($this->ion_auth->in_group('winding'))
				{
					redirect('winding', 'refresh');
				}
			}
			else
			{
