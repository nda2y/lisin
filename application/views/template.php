                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>BENGKEL LISIN</span></a>
                        </div>
                        ...
                        <!-- Query Menu -->
                        <!--
                        $role_id = $this->ion_auth->user('id')->row();
                        $queryMenu = "SELECT 'users_groups'.'group_id', 'groups'.'name'
                                       FROM 'groups'
                                       JOIN 'users_groups' 
                                         ON 'groups'.'id' = 'users_groups'.'group_id'
                                      WHERE 'users_groups'.'user_id' = $role_id
